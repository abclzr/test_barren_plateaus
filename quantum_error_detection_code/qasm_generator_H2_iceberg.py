...
def main(syndrome_frequency, syndrome_noise):
    ...
    code_builder = Iceberg_Code_Builder(circ, 0, 5, [1, 2, 3, 4], 6, 7, clbit_allocator, syndrome_frequency, dmc=None)#dmc=tc.DMCircuit(8))
    ...
    for pauli, coeff in zip(paulis, coeffs):
        ...
        if pauli == 'IIZZ':
            ...
            qasm2.dump(circuit_with_measure_basis, 'H2_iceberg.qasm')
...
if __name__ == "__main__":
    number_trials = 1
    results = {}
    for syndrome_frequency in [6]:#[1, 3, 5]]:
